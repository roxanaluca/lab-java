...
\restrict y0fXpWepgyDc0XECfNzsU4VT66SaTQR4GGTibnQFXrd91WifXeemtXbOXIjCW2C
...
--
-- Name: appdb; Type: SCHEMA; Schema: -; Owner: appuser
--

CREATE SCHEMA appdb;


ALTER SCHEMA appdb OWNER TO appuser;
...
--
-- Name: flyway_schema_history; Type: TABLE; Schema: appdb; Owner: appuser
--

CREATE TABLE appdb.flyway_schema_history (
...
ALTER TABLE appdb.flyway_schema_history OWNER TO appuser;
...
ALTER TABLE public.flyway_schema_history OWNER TO appuser;
...
--
-- Data for Name: flyway_schema_history; Type: TABLE DATA; Schema: appdb; Owner: appuser
--

INSERT INTO appdb.flyway_schema_history VALUES
	(0, NULL, '<< Flyway Schema Creation >>', 'SCHEMA', '"appdb"', NULL, 'appuser', '2025-11-17 13:26:15.670365', 0, true);
...
--
-- Data for Name: flyway_schema_history; Type: TABLE DATA; Schema: public; Owner: appuser
--

INSERT INTO public.flyway_schema_history VALUES
	(1, '1', '<< Flyway Baseline >>', 'BASELINE', '<< Flyway Baseline >>', NULL, 'appuser', '2025-11-17 13:37:28.860537', 0, true);
...
--
-- Name: flyway_schema_history flyway_schema_history_pk; Type: CONSTRAINT; Schema: appdb; Owner: appuser
--

ALTER TABLE ONLY appdb.flyway_schema_history
...
--
-- Name: flyway_schema_history flyway_schema_history_pk; Type: CONSTRAINT; Schema: public; Owner: appuser
--
...
--
-- Name: flyway_schema_history_s_idx; Type: INDEX; Schema: appdb; Owner: appuser
--

CREATE INDEX flyway_schema_history_s_idx ON appdb.flyway_schema_history USING btree (success);


--
-- Name: flyway_schema_history_s_idx; Type: INDEX; Schema: public; Owner: appuser
--
...
\unrestrict y0fXpWepgyDc0XECfNzsU4VT66SaTQR4GGTibnQFXrd91WifXeemtXbOXIjCW2C
